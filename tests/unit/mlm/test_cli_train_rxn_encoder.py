...
#
# from enzrxnpred2.cli.commands.mlm import train_rxn_encoder_cli
...
#
#     @patch('enzrxnpred2.mlm.train_rxn_encoder.train_rxn_encoder')  # TODO: Update package name on publishing code
